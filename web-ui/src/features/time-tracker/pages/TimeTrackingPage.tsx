...
import { Clock, ArrowLeft, Plus, List } from 'lucide-react';
...
export function TimeTrackingPage() {
  ...
  // Hooks
  const { entries, loading, createEntry, deleteEntry, markSynced, refresh } = useTimeEntries();
