...
import { Edit2, Copy, Check, AlertCircle, FileCode, Eye, Search, ChevronDown, ChevronUp } from 'lucide-react';

// Filter types: 'all' | 'assigned' | 'unassigned'
