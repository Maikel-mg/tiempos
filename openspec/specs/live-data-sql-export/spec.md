...
Enable users to generate SQL scripts directly from the Live Time Entries view (Clockify data), allowing selection, preview, and execution of SQL against the configured database without needing to export/import CSV files.
